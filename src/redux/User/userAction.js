...
export const register = (lastname, firstname, gender, city, email, password, birthdate) => async (dispatch) => {
    try {
        dispatch({
        ...
        const { data } = await axios.post(
            ...
            { lastname, firstname, gender, city, email, password, birthdate },
            config)
        dispatch({
...
export const login = (email, password,setErrorHandler,showLoader,hideLoader) => async (dispatch) => {
    try {
        showLoader()
        dispatch({
       ...
       if(data.message=="success admin")
       { history.push("/admin/dashboard")}
       else if(data.message=="success user")
       { history.push("/anis")}
